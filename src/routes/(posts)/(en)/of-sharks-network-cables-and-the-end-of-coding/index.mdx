...
description: "In 2025, the way we build software has fundamentally changed. This article explores my evolution from traditional coding to AI-driven workflows with tools like Claude Code, Windsurf, and Repo Prompt, examining how agents have transformed software development and what this means for engineers navigating this new paradigm."
...
I also started using Codex. GPT-5, 5.1, and 5.2 are great for deep thought and analysis. Opus simply couldn't make plans of that caliber at the time. So, I subscribe to the Max Plan on Claude and the Pro plan on ChatGPT. This allows me to use Codex to my heart's content while also using the Pro interface for its amazing search capabilities. Instead of using Raycast to challenge ideas on different models, the workflow became simpler: use Claude Code for implementation and Codex GPT-5* High for planning. If the task is simple, Opus gets it done. For serious work, I make an initial plan with Opus but always make multiple passes with Codex to make it as perfect as possible.
